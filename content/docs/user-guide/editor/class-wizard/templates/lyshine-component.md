...
A UI component for the LyShine (UI 2.0) system. Use this to create custom UI elements that work within the UiCanvas framework -- buttons, health bars, inventory slots, and other interactive UI elements. The LyShine gem dependency is added for you automatically.
...
For the full generated file list, process commands, and `template.json` schema, see [LyShine Component](/docs/engine-dev/tools/class-wizard/templates/lyshine-component/) in the Developer Guide.
