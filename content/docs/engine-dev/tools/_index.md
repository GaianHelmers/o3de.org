...
| [Class Creation Wizard](./class-wizard) | Learn about the internals of the **Class Creation Wizard**, including template discovery, the command plugin system, and the `template.json` descriptor format. |
